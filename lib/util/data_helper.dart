...
static List<AnnounceEntity> getAnnounceEntity(){
  ...
  datas.add(AnnounceEntity(sendName: "行政部",sendTime: "2020/6/29",title: "会议室变动",desc: "一楼 武汉厅 装修施工完毕，于今日恢复使用。"));
  datas.add(AnnounceEntity(sendName: "行政部",sendTime: "2020/6/20",title: "会议室规范指南",desc: "会议室使用请走预约流程，非必要时不要占领会议室"));
  datas.add(AnnounceEntity(sendName: "行政部",sendTime: "2020/6/23",title: "会议室变动",desc: "四楼 维也纳厅 装修施工完毕，于今日恢复使用。"));
  datas.add(AnnounceEntity(sendName: "行政部",sendTime: "2020/6/22",title: "会议室变动",desc: "三楼 米兰厅 装修施工完毕，于今日恢复使用。"));
  datas.add(AnnounceEntity(sendName: "行政部",sendTime: "2020/6/21",title: "会议室变动",desc: "二楼 纽约厅 装修施工完毕，于今日恢复使用。"));
  return datas;
}
